...
public class DataStoreConsumer {
	public static void main(String[] args) {
		...
		jsonObject.put("Name", "Mohammed Arshath");
		jsonObject.put("Company", "Freshworks");
		...
		//DataStore myDataStore = new DataStore("C:\\Users\\mohammed arshath\\Documents\\DataStore");
		...
		System.out.println(myDataStore.read("2"));// successs
		System.out.println("=============================================================");
